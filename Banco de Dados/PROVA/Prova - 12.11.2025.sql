...
Select carros.marca,count(carros.modelo * carros.marca) 'Total_carros_por_marca' from carros group by marca ;
...
Select carros.marca,count(carros.modelo * carros.marca) 'Total_carros_por_marca' from carros where  (carros.modelo * carros.marca) > 5 group by marca; -- REFAZER 
