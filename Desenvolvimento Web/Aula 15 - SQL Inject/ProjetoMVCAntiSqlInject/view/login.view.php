            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="" method="POST">
                    ...
                    <div>
                        ...
                        <input type="password" name="senha" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>


                    <div>
                        <?php if ($mensagem = flash()->get('validacoes_login')) : ?>
                    ...
                    <p class="text-sm font-light text-white  dark:text-gray-400">
                        Ainda não tem uma conta? <a href="cadastar-se" class=" text-blue-500 font-medium text-primary-600 hover:underline dark:text-primary-500">Cadastar-se </a>
                    </p>
                </form>
            </div>
        </div>
